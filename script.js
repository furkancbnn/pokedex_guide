...
// const pokemonId = pokeman.id.toString().padStart(3,`0`)

// const pokemonType = pokemonId.types[0].type.name
...
// <div class="image-container">
// <img
//   src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${pokemonId.id}.png"
//   alt="Pokemon 1 image"
// />
// </div>
// <div class="poke-info">
// <span class="poke-id">#${pokemonId}</span>
// <h3 class="poke-name">${pokemonId.name}</h3>
// <div class="small">
//   <small class="poke-exp"
//     ><i class="fa-solid fa-flask"></i> <span>${pokemonId.base_experience} Exp</span></small
//   >
//   <small class="poke-weight"
//     ><i class="fa-solid fa-weight-scale"></i> <span>${pokemonId.weight} Kg</span></small
//   >
// </div>
